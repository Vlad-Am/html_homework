        ...
        <main class="row">
                    ...
                    <div class="col-4">
                        <div class="d-grid gap-2 mx-auto">
                            ...
                            <div class="collapse" id="collapseExample2">
                                <div class="card card-body">
                                    Сдек, Боксбери, Авито, Почта России, напишите нашему менеджеру
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>15</td>
                    <td>1500</td>
                    <td class="table-primary">обработан</td>
                </tr>
                <tr>
                    <th scope="row">2</th>
                    <td>тапки</td>
                ...
                <tr>
                    ...
                    <td>1</td>
                    <td>100000</td>
                    <td class="table-danger">отменён</td>
                </tr>
                </tbody>
            </table>
        </main>
